...
import (
	...
	"github.com/estatie/go-zero/tools/goctl/api"
	"github.com/estatie/go-zero/tools/goctl/bug"
	"github.com/estatie/go-zero/tools/goctl/docker"
	"github.com/estatie/go-zero/tools/goctl/env"
	"github.com/estatie/go-zero/tools/goctl/gateway"
	"github.com/estatie/go-zero/tools/goctl/internal/cobrax"
	"github.com/estatie/go-zero/tools/goctl/internal/version"
	"github.com/estatie/go-zero/tools/goctl/kube"
	"github.com/estatie/go-zero/tools/goctl/migrate"
	"github.com/estatie/go-zero/tools/goctl/model"
	"github.com/estatie/go-zero/tools/goctl/quickstart"
	"github.com/estatie/go-zero/tools/goctl/rpc"
	"github.com/estatie/go-zero/tools/goctl/tpl"
	"github.com/estatie/go-zero/tools/goctl/upgrade"
