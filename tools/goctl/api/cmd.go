...
import (
	"github.com/estatie/go-zero/tools/goctl/api/apigen"
	"github.com/estatie/go-zero/tools/goctl/api/dartgen"
	"github.com/estatie/go-zero/tools/goctl/api/docgen"
	"github.com/estatie/go-zero/tools/goctl/api/format"
	"github.com/estatie/go-zero/tools/goctl/api/gogen"
	"github.com/estatie/go-zero/tools/goctl/api/javagen"
	"github.com/estatie/go-zero/tools/goctl/api/ktgen"
	"github.com/estatie/go-zero/tools/goctl/api/new"
	"github.com/estatie/go-zero/tools/goctl/api/tsgen"
	"github.com/estatie/go-zero/tools/goctl/api/validate"
	"github.com/estatie/go-zero/tools/goctl/config"
	"github.com/estatie/go-zero/tools/goctl/internal/cobrax"
	"github.com/estatie/go-zero/tools/goctl/plugin"
